...
Assistant for Fate is a Vue 3 + Ionic hybrid mobile/web app serving as a digital character sheet for the Fate Core RPG system. It targets iOS, Android, and web via Capacitor.
